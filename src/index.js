...
conn.on("chat-update", async (chat) => {
	...
	const body = mtype == "conversation" && content.message.conversation.startsWith(prefix) ? content.message.conversation : mtype == "extendedTextMessage" && content.message.extendedTextMessage.text.startsWith(prefix) ? content.message.extendedTextMessage.text : mtype == "imageMessage" && content.message.imageMessage.caption.startsWith(prefix) ? content.message.imageMessage.caption : mtype == "videoMessage" && content.message.videoMessage.caption.startsWith(prefix) ? content.message.videoMessage.caption : "";
	const from = content.key.remoteJid.includes("@s.whatsapp.net") ? content.key.remoteJid.replace("@s.whatsapp.net", "@c.us") : content.key.remoteJid;
...
conn.get("curi", async (m, args) => {
	...
	const mtype = Object.keys(m.message.extendedTextMessage.contextInfo.quotedMessage)[0]
